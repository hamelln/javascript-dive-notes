...
AST는 바로 기계어로 번역하기 전에 Bytecode로 번역합니다. 기계어보다 메모리 차지율이 적고 JS보다 번역이 빠르기 때문에 성능과 최적화를 하기 적합하기 때문입니다. 이 작업을 담당하는 곳은 Ignition입니다. 점화기라는 뜻을 가진 이그니션은 흔히 인터프리터로서 소개됩니다.(V8에선 이그니션을 "컴파일러"라고 표현할 때도 많습니다. 이후 챕터에서 이그니션에 대해 다시 언급될 텐데 이그니션의 역할을 보면 이해가 될 것입니다.)  
